...
const file_users_proto_users_proto_rawDesc = "" +
	"\n" +
	"\x17users/proto/users.proto\x12\x05users\"\\\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04user\x18\x01 \x01(\v2\v.users.UserR\x04user\"\x1d\n" +
	"\vReadRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"/\n" +
	"\fReadResponse\x12\x1f\n" +
	"\x04user\x18\x01 \x01(\v2\v.users.UserR\x04user\"I\n" +
	"\rUpdateRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\"1\n" +
	"\x0eUpdateResponse\x12\x1f\n" +
	"\x04user\x18\x01 \x01(\v2\v.users.UserR\x04user\"\x1f\n" +
	...
	"\x05Users\x127\n" +
	"\x06Create\x12\x14.users.CreateRequest\x1a\x15.users.CreateResponse\"\x00\x121\n" +
	"\x04Read\x12\x12.users.ReadRequest\x1a\x13.users.ReadResponse\"\x00\x127\n" +
	"\x06Update\x12\x14.users.UpdateRequest\x1a\x15.users.UpdateResponse\"\x00\x127\n" +
	"\x06Delete\x12\x14.users.DeleteRequest\x1a\x15.users.DeleteResponse\"\x00\x121\n" +
	"\x04List\x12\x12.users.ListRequest\x1a\x13.users.ListResponse\"\x00B\x0fZ\r./proto;usersb\x06proto3"
